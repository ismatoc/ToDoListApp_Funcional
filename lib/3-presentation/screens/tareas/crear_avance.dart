...
class _NuevoAvanceSheetState extends ConsumerState<NuevoAvanceSheet> {
  ...
  //   setState(() {
  //     final hh = t?.hour ?? _fechaHora.hour;
  //     final mm = t?.minute ?? _fechaHora.minute;
  //     _fechaHora = DateTime(d.year, d.month, d.day, hh, mm);
  //   });
  // }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //         label: Text(DateFormat('dd/MM/yyyy HH:mm').format(_fechaHora)),
              //       ),
              //     ),
              //   ],
              // ),
              ...
              //       ),
              //     ),
              //     SizedBox(width: 48, child: Text('${_progreso.round()}%', textAlign: TextAlign.right)),
              //   ],
              // ),
