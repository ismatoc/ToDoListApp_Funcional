...
final nowActividadProvider = StateNotifierProvider<LoginNotifier, Login>((ref) {
...
class LoginNotifier extends StateNotifier<Login>{
  ...
  Future<Login> loadAllData(Map<String, dynamic> info) async {
    final Login allData = await fetchAllLogin.getActividades(info);
    state = allData;
...
final actividadesProvider = ChangeNotifierProvider((ref) => LoginProvider());
