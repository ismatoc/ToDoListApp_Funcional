...
final nowAvanceProvider = StateNotifierProvider<LoginNotifier, Login>((ref) {
...
class LoginNotifier extends StateNotifier<Login>{
  ...
  Future<Login> loadAllData(Map<String, dynamic> info) async {
    final Login allData = await fetchAllLogin.getAvance(info);
    state = allData;
...
final avanceProvider = ChangeNotifierProvider((ref) => LoginProvider());
