...
final nowValidaResetProvider = StateNotifierProvider<LoginNotifier, Login>((ref) {
...
class LoginNotifier extends StateNotifier<Login>{
  ...
  Future<Login> loadAllData(Map<String, dynamic> info) async {
    final Login allData = await fetchAllLogin.validarestablecer(info);
    state = allData;
...
final validaresetProvider = ChangeNotifierProvider((ref) => LoginProvider());
