...
final nowResetProvider = StateNotifierProvider<LoginNotifier, Login>((ref) {
...
class LoginNotifier extends StateNotifier<Login>{
  ...
  Future<Login> loadAllData(Map<String, dynamic> info) async {
    final Login allData = await fetchAllLogin.restablecer(info);
    state = allData;
...
final resetProvider = ChangeNotifierProvider((ref) => LoginProvider());
