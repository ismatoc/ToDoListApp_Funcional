...
final nowDashboardProvider = StateNotifierProvider<LoginNotifier, Login>((ref) {
...
class LoginNotifier extends StateNotifier<Login>{
  ...
  Future<Login> loadAllData(Map<String, dynamic> info) async {
    final Login allData = await fetchAllLogin.dashboard(info);
    state = allData;
...
// final tareaProvider = ChangeNotifierProvider((ref) => LoginProvider());
...
//   dynamic _id_tarea;
//   dynamic get id_tarea => _id_tarea;
...
//   void setIdTarea(dynamic newIdTarea){
//     _id_tarea = newIdTarea;
//     notifyListeners();
//   }
// }
